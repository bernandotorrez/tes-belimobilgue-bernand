      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            id = context.query.id;
            _context.next = 3;
            return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_5___default()("https://api.nytimes.com/svc/search/v2/articlesearch.json?fq=subject:(\"".concat(id, "\")&api-key=WD9orPN6fmWSYmGjHaZwnZwW79Ca06xa"));
          ...
          case 6:
            show = _context.sent;
            console.log(show);
            console.log("Fetched show: ".concat(show.response));
...
//# sourceMappingURL=post.js.0b71bc9e73800320e92b.hot-update.js.map